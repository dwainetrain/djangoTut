...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recetly() returns True for questions whose pub_date is within the last day.
        """
    ...
    def create_question(question_text, days):
        ...
        in the past, positive for questions that have yet to be pusblished).
        """
    ...
    class QuestionIndexViewTests(TestCase):
        ...
        def text_future_question_and_past_question(self):
            """
            Even if both past and future questioins exist, only past questions are displayed.
            """
            create_question(question_text="Past question.", days = -30)
            create_question(question_text = "Future question.", days = 30)
            response = self.client.get(reverse('polls:index'))
